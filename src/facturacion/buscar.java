...
public String usu,contra;
    ...
    public buscar(JTextField ncliente) {
        ...
        litabla.addColumn("Autorizacion para credito");
    ...
    private void nclienteKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nclienteKeyTyped
        ...
        try {
            ...
            nombre = "SELECT nombre,cedula_ruc,direccion,codigo,telefono,credito_cliente FROM cliente  WHERE  (nombre) regexp ( '" + nombre + "' ) order by idcliente";
            System.out.println(nombre);
    ...
    private void rclienteKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_rclienteKeyTyped
        ...
        try {
            ...
            nombrec = "SELECT nombre,cedula_ruc,direccion,codigo,telefono,credito_cliente FROM cliente  WHERE  (nombre) regexp ( '" + nombre + "' ) order by idcliente";
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        if (nsurtidor.equals("s1")) {
            f = new File("s1.txt");
            this.clientes.setText(nombrec);
        
                        
           
            
        }
        if (nsurtidor.equals("s2")) {
            f = new File("s2.txt");
            this.clientes.setText(nombrec);
           
            
        }
        if (nsurtidor.equals("s3")) {
            f = new File("s3.txt");
            this.clientes.setText(nombrec);
           
        }
        if (nsurtidor.equals("s4")) {
            f = new File("s4.txt");
            this.clientes.setText(nombrec);
           
        }
        if (nsurtidor.equals("s5")) {
            f = new File("s5.txt");
            this.clientes.setText(nombrec);
            
        }
        if (nsurtidor.equals("s6")) {
            f = new File("s6.txt");
            this.clientes.setText(nombrec);
...
//Escritura
        try {
            ...
            wr.write(cedula + "," + nombrec + "," + direccion + "," + telf);//escribimos en el archivo 
