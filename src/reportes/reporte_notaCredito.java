...
public class reporte_notaCredito implements Runnable{
    ...
    try {
        ...
        { 
          ...
          JasperPrint jasperPrint = JasperFillManager.fillReport( "nota_credito.jasper", pars,  new JRBeanCollectionDataSource(listaproducto));
            ...
            //3. Se exporta a PDF
            JasperExportManager.exportReportToPdfFile(jasperPrint, "ncpdf\\"+nf+".pdf");
            ...
            Logger.getLogger(reporte_notaCredito.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
   public void reporte_factura(String nf,String ruc,String dm,String ds,String ce,String nce,String numAut,String fechahora,String clave,String temision,String ambiente,String rz,String nc,String rzc,String ruc_comp,String f_emision,String guia,String subtotal,String iva,String total,String descuento,String cp,String[] producto,Double []cantidad,String []detalle,Double [] pu,String descuentop,Double []subtotalp){
    ...
    public void run() {
        try
        {
            ...
            message.setSubject(rz + " Nota de Credito N° " + nxml);
 
            texto.setText("Estimado(a) " + ncliente + "\n"
                    + "Presente.\n"
                    + "\n"
                    + "Adjunto sírvase encontrar Nota de Credito Nº"+nxml+" ¹ y el detalle² de dicho comprobante que hemos emitido en nuestra empresa.\n"
