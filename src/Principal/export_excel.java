...
public class export_excel {
	                ...
	                for (int i = 0; i <table.getColumnCount(); i++) {
	                    for (int j = 0; j < table.getRowCount(); j++) {
	                        ...
	                        createColumna(s,table.getColumnName(i),i);//crea la columna
                                ...
                                createFilasString(s,i,j,String.valueOf(objeto));
	    ...
	    /****************************************/
	    private void createFilasString(WritableSheet sheet,int number_columna,int filas,String name_filas)throws WriteException {
			//creamos el tipo de letra
